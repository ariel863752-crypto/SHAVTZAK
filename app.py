...
# ══════════════════════════════════════════════════════════════════
with tab_guide:
    st.markdown("### 📖 מדריך מלא — v6.4")

    st.markdown("#### 👥 קובץ חיילים — `Soldiers.xlsx`")
    st.markdown("""
    <table class="guide-table">
      <thead><tr>
        <th style="width:22%">עמודה</th>
        <th style="width:45%">הסבר</th>
        <th>הנחיות</th>
      </tr></thead>
      <tbody>
        <tr>
        ...
        <tr>
          <td><b>פטורים</b></td>
          <td>מס"ד משימות שהחייל לא יכול לבצע.</td>
          <td><code>101,103</code> — ריק = אין פטור.</td>
        </tr>
        <tr>
          <td><b>הסמכות</b></td>
          <td>רשימת תפקידים / כישורים.</td>
          <td>מופרד בפסיק: <code>נהג, מפקד, קצין</code>.</td>
        </tr>
        <tr>
          <td><b>שעות חסימה</b></td>
          <td>שעות בהן החייל אינו זמין כלל.</td>
          <td>טווח: <code>10-14</code>. טווח חוצה חצות: <code>22-6</code>. ריק = זמין תמיד.</td>
        </tr>
      </tbody>
    </table>
    """, unsafe_allow_html=True)
    ...
    <table class="guide-table">
      ...
      <tbody>
        <tr>
          <td><b>מס"ד משימה</b></td>
          <td>מזהה ייחודי למשימה.</td>
          <td>חייב להתאים לפטורים בקובץ החיילים.</td>
        </tr>
        <tr>
          <td><b>שם המשימה</b></td>
          <td>שם שיופיע בלוח השיבוץ.</td>
          <td>קצר וברור.</td>
        </tr>
        <tr>
          <td><b>סד"כ נדרש למשימה</b></td>
          <td>סך כל החיילים הנדרשים בעמדה בכל שעה פעילה.</td>
          <td>כולל בעלי תפקידים מיוחדים + כלליים.</td>
        </tr>
        <tr>
          <td><b>משך משמרת</b></td>
          <td>שעות רצופות שחייל "נעול" במשימה.</td>
          <td>תומך במשמרות חוצות חצות (מעגלי).</td>
        </tr>
        <tr>
          <td><b>שעות מנוחה בין משימות</b></td>
          <td>שעות חסימה לאחר סיום המשמרת.</td>
          <td>4ש' שמירה + 8ש' מנוחה = חסום 12 שעות מרגע ההתחלה.</td>
        </tr>
        <tr>
          <td><b>אישור חפיפה בין משימות</b></td>
          <td>ניתן לבצע במקביל למשימה אחרת?</td>
          <td><code>True</code> — כוננות. <code>False</code> — שמירה / מטבח.</td>
        </tr>
        <tr>
          <td><b>שעות פעילות</b></td>
          <td>השעות שבהן המשימה מתקיימת.</td>
          <td><code>all</code>, רשימה <code>7,8,9</code>, או טווח <code>8-12</code>.</td>
        </tr>
        <tr>
          <td><b>הסמכה נדרשת</b></td>
          <td>תפקידים חייבים לאייש slot ספציפי.</td>
          <td><code>נהג, מפקד</code> = slot ראשון לנהג, שני למפקד, שאר כלליים.</td>
        </tr>
        <tr>
          <td><b>דירוג עצימות המשימה</b></td>
          <td>קושי יחסי (1–3).</td>
          <td>האלגוריתם מאזן גם לפי עצימות, לא רק שעות.</td>
        </tr>
        <tr>
          <td><b>תפקידים חסומים</b></td>
          <td>מי <b>אסור</b> לבצע משימה זו.</td>
          <td><code>קצין, נגד</code> — חייל עם אחד מהתפקידים האלה חסום לחלוטין.</td>
        </tr>
      </tbody>
    </table>
    """, unsafe_allow_html=True)
